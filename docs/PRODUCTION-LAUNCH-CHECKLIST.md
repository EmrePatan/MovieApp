...
| Resend email (shared) | `Authentication:Email:Resend` → `Authentication__Email__Resend__ApiKey`, `FromAddress=noreply@moviecaveapp.com`, `FromName=Movie Cave` (see `docs/PRODUCTION-EMAIL.md`) | [ ] | [ ] |
