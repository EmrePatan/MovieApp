...
| Resend email (shared) | `Authentication:Email:Resend` → `Authentication__Email__Resend__ApiKey`, `FromAddress`, `FromName` (`onboarding@resend.dev` OK until custom domain verified — see `docs/PRODUCTION-EMAIL.md`) | [ ] | [ ] |
