...
public sealed class WatchHistoryWebApplicationFactory : WebApplicationFactory<Program>
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        Environment.SetEnvironmentVariable(
            ...
            WatchHistoryIntegrationDatabase.GetConnectionString());
        Environment.SetEnvironmentVariable(
        ...
        builder.ConfigureAppConfiguration((_, configurationBuilder) =>
        {
            ...
            configuration["PostgreSql:ConnectionString"] = WatchHistoryIntegrationDatabase.GetConnectionString();
