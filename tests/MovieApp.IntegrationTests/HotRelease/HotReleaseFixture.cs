...
public sealed class HotReleaseFixture : IAsyncLifetime
{
    public HotReleaseWebApplicationFactory Factory { get; } = new();
    ...
    internal static ApplicationDbContext CreateContext()
    {
        var options = new DbContextOptionsBuilder<ApplicationDbContext>()
            .UseNpgsql(HotReleaseIntegrationDatabase.GetConnectionString())
            .Options;
