...
public sealed class HomeApiFixture : IAsyncLifetime
{
    public HomeWebApplicationFactory Factory { get; } = new();
    ...
    private static ApplicationDbContext CreateContext()
    {
        var options = new DbContextOptionsBuilder<ApplicationDbContext>()
            .UseNpgsql(HomeIntegrationDatabase.GetConnectionString())
            .Options;
