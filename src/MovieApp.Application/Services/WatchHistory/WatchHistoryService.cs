    ...
    IServiceScopeFactory? analyticsScopeFactory = null) : IWatchHistoryService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        WatchHistoryPerfLogMessages.LogTvWatchStateIngestion(
            ...
            ingestionResult.PersistenceExistingDataLoadMs,
            ingestionResult.PersistenceMutationMs,
            ingestionResult.PersistenceSaveChangesMs,
            ingestionResult.PersistenceIncomingEpisodeCount,
            ingestionResult.PersistenceAddedEpisodeCount,
            ingestionResult.PersistenceUpdatedEpisodeCount,
