...
namespace MovieApp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260926023533_AddContentSearchTitleTitleTrigramIndex")]
    partial class AddContentSearchTitleTitleTrigramIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieApp.Domain.Entities.ContentSearchTitle", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ProviderTitleType")
                        .HasMaxLength(64)
                    ...
                    b.HasIndex("ContentType", "ContentId", "NormalizedTitle")
                        .IsUnique()
                        .HasDatabaseName("UX_content_search_titles_ContentType_ContentId_NormalizedTitle");

                    b.ToTable("content_search_titles", (string)null);
                });
            ...
            modelBuilder.Entity("MovieApp.Domain.Entities.ExternalRatingSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MediaType", "TmdbId", "Provider")
                        .IsUnique();

                    b.ToTable("external_rating_snapshots", (string)null);
                });
            ...
            modelBuilder.Entity("MovieApp.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MovieApp.Domain.Entities.Review", b =>
                {
                    ...
                    b.Property<string>("AuthoringLocale")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");
