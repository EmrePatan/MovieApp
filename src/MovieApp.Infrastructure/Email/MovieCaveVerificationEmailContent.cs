...
public static class MovieCaveVerificationEmailContent
{
    ...
    public static string BuildHtml(string verifyUrl, string? heroImageUrl)
    {
        ...
        builder.Append("""
              ...
              <style type="text/css">
                ...
                @media only screen and (max-width: 620px) {
                  ...
                  .hero-headline { font-size: 22px !important; line-height: 30px !important; }
        ...
        builder.Append(canvasBackground);
        builder.Append("\"><tr><td align=\"center\" class=\"outer-padding\" style=\"padding:28px 16px;");
        builder.Append(canvasBackground);
        ...
        builder.Append(" style=\"padding:24px 32px 8px 32px;");
        builder.Append(cardBackground);
        builder.Append("\"><table role=\"presentation\" width=\"56\" height=\"56\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" align=\"center\" style=\"margin:0 auto 16px auto;\"><tr><td align=\"center\" valign=\"middle\" width=\"56\" height=\"56\" bgcolor=\"#1A1712\" style=\"width:56px;height:56px;background-color:#1A1712;background-image:linear-gradient(#1A1712,#1A1712);border:1px solid ");
        builder.Append(GoldAccentColor);
        builder.Append(";font-size:24px;line-height:56px;color:");
        builder.Append(GoldAccentColor);
        builder.Append(";font-family:Arial,Helvetica,sans-serif;\">&#9993;</td></tr></table>");
        ...
        builder.Append(cardBackground);
        builder.Append(" style=\"padding:8px 32px 24px 32px;");
        builder.Append(cardBackground);
        ...
        builder.Append(" style=\"border-radius:999px;");
        builder.Append(ctaBackground);
        builder.Append("\"><a class=\"cta-link\" href=\"");
        builder.Append(encodedVerifyUrl);
        builder.Append("\" style=\"display:inline-block;padding:15px 30px;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;color:");
        builder.Append(CtaTextColor);
        builder.Append(";text-decoration:none;border-radius:999px;");
        builder.Append(ctaBackground);
        builder.Append("mso-padding-alt:15px 30px;\">Verify Email Address &rarr;</a></td></tr></table></td></tr>");
        builder.Append("<tr><td class=\"section-padding dark-surface\" ");
        builder.Append(cardBackground);
        builder.Append(" style=\"padding:0 32px 20px 32px;");
        builder.Append(cardBackground);
        builder.Append("\"><p style=\"margin:0;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:22px;color:#AFA79B;text-align:center;\">If you didn&apos;t create a Movie Cave account, you can safely ignore this email.</p></td></tr>");
        builder.Append("<tr><td class=\"section-padding dark-surface\" ");
        builder.Append(cardBackground);
        ...
        builder.Append(GoldAccentColor);
        builder.Append(";font-weight:700;\">Movie Cave</p><p style=\"margin:0;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:20px;color:#AFA79B;\">Your cinematic home for movies and TV.</p></td></tr></table></td></tr></table></body></html>");
    ...
    private static string BuildHeroSectionHtml(string? heroImageUrl)
    {
            ...
            (heroUri.Scheme == Uri.UriSchemeHttps || heroUri.Scheme == Uri.UriSchemeHttp))
        {
            ...
            builder.Append(cardBackground);
            builder.Append("\"><p class=\"hero-headline\" style=\"margin:0;font-family:Georgia,'Times New Roman',serif;font-size:26px;line-height:34px;font-weight:400;color:");
            builder.Append(PrimaryTextColor);
            builder.Append(";text-align:center;\">One more step to the good stuff.</p></td></tr>");
            return builder.ToString();
        }
        ...
        fallbackHero.Append(cardBackground);
        fallbackHero.Append("\"><p class=\"hero-headline\" style=\"margin:0;font-family:Georgia,'Times New Roman',serif;font-size:24px;line-height:32px;font-weight:400;color:");
        fallbackHero.Append(PrimaryTextColor);
        fallbackHero.Append(";text-align:center;\">One more step to the good stuff.</p></td></tr></table></td></tr>");
