...
public static class MovieCavePasswordResetEmailContent
{
    ...
    private static readonly PasswordResetEmailCopy EnglishCopy = new(
        ...
        BodyHtml: "We received a request to reset your Movie Cave password. Use the link below to choose a new password.",
    ...
    private static readonly PasswordResetEmailCopy TurkishCopy = new(
        ...
        BodyHtml: "Movie Cave şifreni sıfırlamak için bir istek aldık. Yeni bir şifre belirlemek için aşağıdaki bağlantıyı kullan.",
    ...
    private static readonly PasswordResetEmailCopy GermanCopy = new(
        HtmlLang: "de",
        Subject: "Movie-Cave-Passwort zurücksetzen",
        Preheader: "Erstelle ein neues Passwort für dein Movie-Cave-Konto.",
        HeroHeadline: "Lass uns wieder in dein Konto.",
        Title: "Passwort zurücksetzen",
        BodyPlain: "Wir haben eine Anfrage erhalten, dein Movie-Cave-Passwort zurückzusetzen. Nutze den Link unten, um ein neues Passwort zu erstellen.",
        BodyHtml: "Wir haben eine Anfrage erhalten, dein Movie-Cave-Passwort zurückzusetzen. Nutze den Link unten, um ein neues Passwort zu erstellen.",
        PlainTextCtaLabel: "Passwort zurücksetzen:",
        CtaHtml: "Passwort zurücksetzen &rarr;",
        SafetyHtml: "Wenn du keine Passwort-Zurücksetzung angefordert hast, kannst du diese E-Mail ignorieren. Dein Passwort wird nicht geändert.",
        Feature1Label: "SICHER",
        Feature1PlainText: "Kontoschutz",
        Feature1TextHtml: "Kontoschutz",
        Feature2Label: "SCHNELL",
        Feature2PlainText: "Einmaliger Link",
        Feature2TextHtml: "Einmaliger Link",
        Feature3Label: "ZURÜCK",
        Feature3PlainText: "Zu deiner Merkliste",
        Feature3TextHtml: "Zu deiner Merkliste",
        FooterTagline: "Dein filmisches Zuhause für Filme und Serien.",
        Safety: "Wenn du keine Passwort-Zurücksetzung angefordert hast, kannst du diese E-Mail ignorieren. Dein Passwort wird nicht geändert.");

    private static readonly PasswordResetEmailCopy FrenchCopy = new(
        HtmlLang: "fr",
        Subject: "Réinitialisez votre mot de passe Movie Cave",
        Preheader: "Créez un nouveau mot de passe pour votre compte Movie Cave.",
        HeroHeadline: "Retournons à votre compte.",
        Title: "Réinitialiser le mot de passe",
        BodyPlain: "Nous avons reçu une demande de réinitialisation de votre mot de passe Movie Cave. Utilisez le lien ci-dessous pour créer un nouveau mot de passe.",
        BodyHtml: "Nous avons reçu une demande de réinitialisation de votre mot de passe Movie Cave. Utilisez le lien ci-dessous pour créer un nouveau mot de passe.",
        PlainTextCtaLabel: "Réinitialiser le mot de passe :",
        CtaHtml: "Réinitialiser le mot de passe &rarr;",
        SafetyHtml: "Si vous n'avez pas demandé une réinitialisation, vous pouvez ignorer cet e-mail. Votre mot de passe ne changera pas.",
        Feature1Label: "SÉCURISÉ",
        Feature1PlainText: "Protection du compte",
        Feature1TextHtml: "Protection du compte",
        Feature2Label: "RAPIDE",
        Feature2PlainText: "Lien à usage unique",
        Feature2TextHtml: "Lien à usage unique",
        Feature3Label: "RETOUR",
        Feature3PlainText: "À votre liste",
        Feature3TextHtml: "À votre liste",
        FooterTagline: "Votre foyer cinéma pour films et séries.",
        Safety: "Si vous n'avez pas demandé une réinitialisation, vous pouvez ignorer cet e-mail. Votre mot de passe ne changera pas.");

    private static readonly PasswordResetEmailCopy ItalianCopy = new(
        HtmlLang: "it",
        Subject: "Reimposta la password Movie Cave",
        Preheader: "Crea una nuova password per il tuo account Movie Cave.",
        HeroHeadline: "Torniamo al tuo account.",
        Title: "Reimposta password",
        BodyPlain: "Abbiamo ricevuto una richiesta di reimpostazione della password Movie Cave. Usa il link qui sotto per creare una nuova password.",
        BodyHtml: "Abbiamo ricevuto una richiesta di reimpostazione della password Movie Cave. Usa il link qui sotto per creare una nuova password.",
        PlainTextCtaLabel: "Reimposta password:",
        CtaHtml: "Reimposta password &rarr;",
        SafetyHtml: "Se non hai richiesto il reset della password, puoi ignorare questa e-mail. La password non cambierà.",
        Feature1Label: "SICURO",
        Feature1PlainText: "Protezione account",
        Feature1TextHtml: "Protezione account",
        Feature2Label: "VELOCE",
        Feature2PlainText: "Link monouso",
        Feature2TextHtml: "Link monouso",
        Feature3Label: "TORNA",
        Feature3PlainText: "Alla tua watchlist",
        Feature3TextHtml: "Alla tua watchlist",
        FooterTagline: "La tua casa cinematografica per film e serie.",
        Safety: "Se non hai richiesto il reset della password, puoi ignorare questa e-mail. La password non cambierà.");

    private static readonly PasswordResetEmailCopy PortugueseBrazilCopy = new(
        HtmlLang: "pt-BR",
        Subject: "Redefina sua senha do Movie Cave",
        Preheader: "Crie uma nova senha para sua conta Movie Cave.",
        HeroHeadline: "Vamos voltar à sua conta.",
        Title: "Redefinir senha",
        BodyPlain: "Recebemos uma solicitação para redefinir sua senha do Movie Cave. Use o link abaixo para criar uma nova senha.",
        BodyHtml: "Recebemos uma solicitação para redefinir sua senha do Movie Cave. Use o link abaixo para criar uma nova senha.",
        PlainTextCtaLabel: "Redefinir senha:",
        CtaHtml: "Redefinir senha &rarr;",
        SafetyHtml: "Se você não solicitou a redefinição de senha, pode ignorar este e-mail. Sua senha não será alterada.",
        Feature1Label: "SEGURO",
        Feature1PlainText: "Proteção da conta",
        Feature1TextHtml: "Proteção da conta",
        Feature2Label: "RÁPIDO",
        Feature2PlainText: "Link de uso único",
        Feature2TextHtml: "Link de uso único",
        Feature3Label: "VOLTE",
        Feature3PlainText: "Para sua lista",
        Feature3TextHtml: "Para sua lista",
        FooterTagline: "Seu lar cinematográfico para filmes e séries.",
        Safety: "Se você não solicitou a redefinição de senha, pode ignorar este e-mail. Sua senha não será alterada.");
}
